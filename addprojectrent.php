<?php
    include('indexDB.php');
    session_start();
    $loc=$city=$desc=$am=$ar=$i=$i1=$i2=$i3=$i4=$rent=$dep=$time='';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (empty($_POST["loc"])) {
      ...
      if (empty($_POST["img1"])) {
        ...
        $i4= test_input($_POST["Virtual Tour"]);
...
{
    $id='uid';
    $q1="insert into flat(location,$id,city,description,amenities,area,image,image1,image2,image3,image4) values('$loc',".$_SESSION['id'].",'$city','$desc','$am',$ar,'$i','$i1','$i2','$i3','$i4')";
    echo $q1;
    $x=$conn->query($q1);
...
<tr>
<td colspan=2>
<center><img src="img/logo2.png"></img></center>
</td>
</tr>
<tr>
<td colspan=2>
...
<tr>
<td><b>Virtual Tour URL</b></td>
<td><input type="text" name="Virtual Tour" size="30">
