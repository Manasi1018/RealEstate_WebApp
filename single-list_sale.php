			...
			<div class="row">
				<div class="col-12">
					<div class="site-navbar">
						<a href="#" class="site-logo"><img src="img/logo2.png" alt=""></a>
		...
		<div class="container">
          ...
          <div class="single-list-content">
						...
						<div class="row property-details-list">
							...
							<h3 class="sl-sp-title">Virtual Tour</h3>
						<iframe width="680" height="600"  src="https://viewer.divein.studio/story/ey7AGHHSW3"<?php echo 
						$row['image4'] ?>" frameborder="0" allowfullscreen></iframe>
